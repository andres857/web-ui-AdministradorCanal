<template>
  <b-container>
    <b-list-group>
        <b-list-group-item v-b-toggle.collapse-5 @click="getStatusPlayer" class="d-flex justify-content-between align-items-center" >
          ...
          <b-collapse id="collapse-5" class="mb-3" >
            <b-card>
                <b-container>
                  <b-row >
  ...
  data() {
    return {
      ...
      options:{
        ...
        clientId: 'webClientPlayermedicinanuclear',
        username: 'emqx',
        password: 'public',
      },
      ...
      topics: {
        subscriber:{
          status:'imbanaco/principal/players/medicinanuclear/tv1/6bf9698ab805438e8515dc7af249fef1/status',
          currentStreaming:'imbanaco/principal/players/medicinanuclear/tv1/6bf9698ab805438e8515dc7af249fef1/currentStreaming',
        },
        publish:{
          restart:'imbanaco/principal/players/medicinanuclear/tv1/6bf9698ab805438e8515dc7af249fef1/restart',
          getStatus: 'imbanaco/principal/players/medicinanuclear/tv1/6bf9698ab805438e8515dc7af249fef1/getstatus',
          urlStreaming:'imbanaco/principal/players/medicinanuclear/tv1/6bf9698ab805438e8515dc7af249fef1/urlStreaming',
        },
      },
