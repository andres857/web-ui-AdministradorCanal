<template>
  <b-container>
    <b-list-group>
        <b-list-group-item v-b-toggle.collapse-1 @click="getStatusPlayer" class="d-flex justify-content-between align-items-center" >
  ...
  data() {
    return {
      ...
      options:{
        ...
        clientId: 'webClientPlayeresperaadultos',
        username: 'emqx',
        password: 'public',
      },
      ...
      topics: {
        subscriber:{
          status:'imbanaco/principal/players/salaesperaadultos/tv1/0937a763e981416d8e711c2b3b52b358/status',
          currentStreaming:'imbanaco/principal/players/salaesperaadultos/tv1/0937a763e981416d8e711c2b3b52b358/currentStreaming',
        },
        publish:{
          restart:'imbanaco/principal/players/salaesperaadultos/tv1/0937a763e981416d8e711c2b3b52b358/restart',
          getStatus: 'imbanaco/principal/players/salaesperaadultos/tv1/0937a763e981416d8e711c2b3b52b358/getstatus',
          urlStreaming:'imbanaco/principal/players/salaesperaadultos/tv1/0937a763e981416d8e711c2b3b52b358/urlStreaming',
        },
      },
