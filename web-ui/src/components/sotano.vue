<template>
  <b-container >
    <b-list-group>
        <b-list-group-item v-b-toggle.collapse-3 @click="loadinfo" class="d-flex justify-content-between align-items-center" >
...
export default {
  data() {
    return {
      ...
      subscription: {
        topics: ['imbanaco/principal/players/Sotano/tv1/ef8226d35f8246db8ea4fc7a4292f9a4/network',
                'imbanaco/principal/players/Sotano/tv1/ef8226d35f8246db8ea4fc7a4292f9a4/load'],
        qos: 0,
      },
      
      publishRestartDevice: {
        topic: 'imbanaco/principal/players/Sotano/tv1/ef8226d35f8246db8ea4fc7a4292f9a4/config',
        qos: 0,
      ...
      publishUrlStreaming: {
        topic: 'imbanaco/principal/players/Sotano/tv1/ef8226d35f8246db8ea4fc7a4292f9a4/urlStreaming',
        qos: 0,
