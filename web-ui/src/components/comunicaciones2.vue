  ...
  data() {
    return {
      ...
      options:{
        ...
        clientId: 'webClientComnucaciones2',
        username: 'emqx',
        password: 'public',
      },
      ...
      topics: {
        subscriber:{
          status:'player/status/27151e',
          response: 'player/response/27151e',
          currentStreaming: 'player/currentstreaming/27151e'
        },
        publish:{
          request: 'player/request/27151e'
        },
      },
      payloads:{
