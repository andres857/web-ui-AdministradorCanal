            ...
            <b-row align-h="center">
              ...
              <b-col cols="4">
                <b-row align-h="center">
                  <b-col cols="2">
                    <div>
                      <b-button v-b-toggle="'collapse-2'" variant="success">+</b-button>
                    </div>
                  </b-col>
                  <b-col>
                    <div>
...
export default {
  ...
  data() {
    return {
      ...
      topics: {
        subscriber:{
          status:'windowschannel/player/status/1f2899',
          response: 'windowschannel/player/response/1f2899',
          currentStreaming: 'windowschannel/player/currentstreaming/1f2899'
        },
        publish:{
          request: 'windowschannel/player/request/1f2899',
          newStreaming: 'windowschannel/player/streaming/1f2899',
        },
      },
      payloads:{
