  ...
  data() {
    return {
      ...
      options:{
        ...
        clientId: 'webClientPlayertekteam',
        username: 'emqx',
        password: 'public',
      },
      ...
      topics: {
        subscriber:{
          status:'player/status/8f370d',
          response: 'player/response/8f370d',
          currentStreaming: 'player/currentstreaming/8f370d'
        },
        publish:{
          request: 'player/request/8f370d'
        },
      },
      payloads:{
