<template>
  <b-container >
    <b-list-group>
        <b-list-group-item v-b-toggle.collapse-2 @click="loadinfo" class="d-flex justify-content-between align-items-center" >
          <b-icon icon="circle-fill" :variant="background"></b-icon>
          <span class="text-center"> Urgencias </span>
...
export default {
  data() {
    return {
      ...
      subscription: {
        topics: ['imbanaco/principal/players/urgencias/tv1/ddcef5209dc54d318d0afc859a42b7c2/network',
                'imbanaco/principal/players/urgencias/tv1/ddcef5209dc54d318d0afc859a42b7c2/load'],
        qos: 0,
      },
      
      publishRestartDevice: {
        topic: 'imbanaco/principal/players/urgencias/tv1/ddcef5209dc54d318d0afc859a42b7c2/config',
        qos: 0,
      ...
      publishUrlStreaming: {
        topic: 'imbanaco/principal/players/urgencias/tv1/ddcef5209dc54d318d0afc859a42b7c2/urlStreaming',
        qos: 0,
