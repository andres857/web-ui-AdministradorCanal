  ...
  data() {
    return {
      ...
      options:{
        ...
        clientId: 'webClientcomunicaciones1',
        username: 'emqx',
        password: 'public',
      },
      ...
      topics: {
        subscriber:{
          status:'player/status/15a6ec',
          response: 'player/response/15a6ec',
          currentStreaming: 'player/currentstreaming/15a6ec'
        },
        publish:{
          request: 'player/request/15a6ec'
        },
      },
      payloads:{
